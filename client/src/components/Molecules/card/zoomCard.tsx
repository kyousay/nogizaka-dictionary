    ...
    <Wrapper styled={{...zoomFieldStyle}} onClick={props.zoomOutHandler}>
        <Wrapper styled={{...contentStyle}}>
            ...
            <Wrapper styled={{margin: '17px 0 0 0'}}>
                ...
                display={"flex"} color={"#787878"} titleSize={'1.2rem'} subSize={'1.4rem'} width={'108px'} padding={'12px 0 0 0'} border_top={'1px solid #D8D8D8'}/>
                <TxtRowSection title={"血液型"} content={props.blod} 
                display={"flex"} color={"#787878"} titleSize={'1.2rem'} subSize={'1.4rem'} margin={'17px 0 0'} width={'108px'}/>
